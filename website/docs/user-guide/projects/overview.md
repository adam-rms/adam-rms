...
### Additional Project Settings Menu

Many of the project settings can be updated by using functionality found in the additional project settings menu. These include updating the name and description of a project, assigning a parent project or creating sub-projects and archiving or deleting the project.

![Additional Project Settings Menu](/img/tutorial/projects/projects-additional-settings.png)
...
_Notes and Projects for the project_
...
_A Subproject that tracks the parent's project status_

Use the additional project settings menu to enable or disable parent status tracking on subprojects.
