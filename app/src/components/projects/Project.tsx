import { IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonCol, IonItem, IonLabel, IonList, IonRefresher, IonRefresherContent, IonRow, IonTitle } from "@ionic/react";
                        ...
                        <IonCol>
                            <IonItem>
                                <div className="container">
                                    ...
                                    {projectData.project.projects_manager ? <IonCardTitle>{projectData.project.users_name1} {projectData.project.users_name2}</IonCardTitle> : <IonCardTitle>Unknown</IonCardTitle>}
                                </div>
                            </IonItem>
                            {projectData.project.projectsTypes_config_client && <IonItem>
                                <div className="container">
                                    <IonCardSubtitle>Client</IonCardSubtitle>
                                    {projectData.project.clients_id ? <IonCardTitle>{projectData.project.clients_name}</IonCardTitle> : <IonCardTitle>Unknown</IonCardTitle>}
                                </div>
                            </IonItem> }
                            {projectData.project.projectsTypes_config_venue && <IonItem>
                                <div className="container">
                                    <IonCardSubtitle>Venue</IonCardSubtitle>
                                    {projectData.project.clients_id ? <IonCardTitle>{projectData.project.locations_name}</IonCardTitle> : <IonCardTitle>Unknown</IonCardTitle>}
                                </div>
                            </IonItem> }
                        </IonCol>
                        <IonCol>
