          ...
          {appPages.map((appPage, index) => {
            return (
              <IonMenuToggle key={index} autoHide={false}>
                <StyledIonItem className={location.pathname === appPage.url ? 'selected' : ''} routerLink={appPage.url} routerDirection="none" lines="none" detail={false}>
                  <StyledIonLabel slot="start"><FontAwesomeIcon icon={appPage.icon} size="2x" /></StyledIonLabel>
