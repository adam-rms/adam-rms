...
header("Content-Security-Policy: default-src 'none';" .
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.adam-rms.com https://cdnjs.cloudflare.com  https://static.cloudflareinsights.com https://*.freshstatus.io;".
    ...
    "connect-src 'self' https://sentry.io https://cloudflareinsights.com https://*.adam-rms.com     https://*.freshstatus.io;".
    //                  Error reporting    CF Analytics                  Connecting to AdamRMS API   Status Page
    "frame-src https://*.freshstatus.io;".
