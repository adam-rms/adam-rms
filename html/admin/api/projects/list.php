...
$projects = $DBLIB->get("projects", null, ["projects_id", "projects_archived", "projects_name", "clients_name", "projects_dates_deliver_start", "projects_dates_deliver_end", "projects_dates_use_start", "projects_dates_use_end", "projects_status", "projects_customProjectStatus", "projects_manager"]);
foreach ($projects as $project) {
    $return[] = [
        ...
        "projects_status" => $project['projects_status'],
        "projects_customProjectStatus" => $project['projects_customProjectStatus'],
