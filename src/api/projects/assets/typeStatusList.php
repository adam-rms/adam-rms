 ...
 *     summary="Get Asset Type Assignment Status List", 
 *     description="Get the list of statuses for an asset type assignment  
Requires Instance Permission PROJECTS:VIEW
", 
 *     operationId="getAssetTypeAssignmentStatusList", 
 *     tags={"project_assets"}, 
 *     @OA\Response(
 *         response="200", 
 *         description="Success",
