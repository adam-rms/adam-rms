...
const writeCases: ApiCase[] = [
  ...
  // Business settings
  { endpoint: "/api/instances/editInstance.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: () => ({ formData: formData({ instances_phone: "01234 567890" }) }) },
  { endpoint: "/api/instances/editCalendarSettings.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: () => ({ formData: formData({ defaultView: "timeGridWeek" }) }) },
  { endpoint: "/api/instances/editInstancePublicSite.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: () => ({ formData: formData({ enabled: "on" }) }) },
  { endpoint: "/api/instances/editInstanceTrustedDomains.php", permission: "BUSINESS:SETTINGS:EDIT:TRUSTED_DOMAINS", params: (a) => ({ formData: formData({ domains: "example.org", instancePositions_id: a.positions.limited, userInstances_label: "e2e" }) }) },
  { endpoint: "/api/instances/assetAssignmentStatus/new.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: () => ({ statusName: "E2E_TENANT_A_SECRET status by e2e", statusOrder: 5 }) },
  { endpoint: "/api/instances/assetAssignmentStatus/edit.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: (a) => ({ statusId: a.assignmentStatusId, statusName: "Renamed by e2e" }) },
  { endpoint: "/api/instances/assetAssignmentStatus/delete.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: (a) => ({ statusId: a.assignmentStatusId }) },
  { endpoint: "/api/instances/assetAssignmentStatus/reorder.php", permission: "BUSINESS:BUSINESS_SETTINGS:EDIT", params: (a) => ({ order: ["", a.assignmentStatusId] }) },
  { endpoint: "/api/instances/projectStatus/new.php", permission: "PROJECTS:PROJECT_STATUSES:CREATE", params: () => ({ formData: formData({ projectsStatuses_name: "E2E_TENANT_A_SECRET status by e2e", projectsStatuses_description: "e2e", projectsStatuses_foregroundColour: "#000000", projectsStatuses_backgroundColour: "#ffffff", projectsStatuses_rank: 9 }) }) },
  { endpoint: "/api/instances/projectStatus/edit.php", permission: "PROJECTS:PROJECT_STATUSES:EDIT", params: (a) => ({ formData: formData({ projectsStatuses_id: a.projectStatusIds.first, projectsStatuses_name: "Renamed by e2e" }) }) },
  { endpoint: "/api/instances/projectStatus/editPageRank.php", permission: "PROJECTS:PROJECT_STATUSES:EDIT", params: (a) => ({ order: ["", "", a.projectStatusIds.first] }) },
  { endpoint: "/api/instances/projectTypes/new.php", permission: "PROJECTS:PROJECT_TYPES:CREATE", params: () => ({ formData: formData({ projectsTypes_name: "E2E_TENANT_A_SECRET type by e2e" }) }) },
  { endpoint: "/api/instances/projectTypes/edit.php", permission: "PROJECTS:PROJECT_TYPES:EDIT", params: (a) => ({ formData: formData({ projectsTypes_id: a.projectTypeId, projectsTypes_name: "Renamed by e2e" }) }) },
  { endpoint: "/api/instances/signupCodes/new.php", permission: "BUSINESS:USER_SIGNUP_CODES:CREATE", params: (a) => ({ formData: formData({ signupCodes_name: `e2e-permission-${Date.now()}`, signupCodes_role: "e2e", instancePositions_id: a.positions.limited }) }) },
  { endpoint: "/api/instances/signupCodes/edit.php", permission: "BUSINESS:USER_SIGNUP_CODES:EDIT", params: (a) => ({ formData: formData({ signupCodes_id: a.signupCodeId, signupCodes_notes: "Changed by e2e" }) }) },
  { endpoint: "/api/instances/archiveUser.php", permission: "BUSINESS:USERS:EDIT:ARCHIVE", params: (a) => ({ userid: a.users.deleted.id }) },
  { endpoint: "/api/instances/removeUser.php", permission: "BUSINESS:USERS:DELETE:REMOVE_FORM_BUSINESS", params: (a) => ({ userid: a.users.deleted.id }) },
  { endpoint: "/api/instances/addUser.php", permission: "BUSINESS:USERS:CREATE:ADD_USER_BY_EMAIL", params: (a) => ({ rolegroup: a.positions.limited, rolename: "e2e", users: [a.users.deleted.id] }) },
  { endpoint: "/api/instances/editUser.php", permission: "BUSINESS:USERS:EDIT:CHANGE_ROLE", params: (a) => ({ userinstanceid: a.deletedMembershipId, position: a.positions.full, label: "e2e" }) },
  { endpoint: "/api/permissions/newInstancePosition.php", permission: "BUSINESS:ROLES_AND_PERMISSIONS:CREATE", params: () => ({ name: "Role by e2e" }) },
  { endpoint: "/api/permissions/instancePermissionsEditor.php", permission: "BUSINESS:ROLES_AND_PERMISSIONS:EDIT", params: (a) => ({ position: a.positions.limited, addpermission: "PROJECTS:DELETE" }) },
  // Clients
...
const refusedPages: { file: string; url: string | ((a: Tenant) => string); permission: string }[] = [
  ...
  ...[
    ["instances/calendarSettings.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"], ["instances/configuration/asset-status.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"],
    ["instances/configuration/barcodes.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"], ["instances/configuration/invoices.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"],
    ["instances/configuration/logo.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"], ["instances/public.php", "BUSINESS:BUSINESS_SETTINGS:VIEW"],
    ["instances/stats.php", "BUSINESS:BUSINESS_STATS:VIEW"], ["instances/trustedDomains.php", "BUSINESS:SETTINGS:EDIT:TRUSTED_DOMAINS"],
    ["instances/customCategories.php", "ASSETS:ASSET_CATEGORIES:VIEW"], ["instances/projectStatuses.php", "PROJECTS:PROJECT_STATUSES:VIEW"],
    ["instances/projectTypes.php", "PROJECTS:PROJECT_TYPES:VIEW"], ["instances/signupCodes.php", "BUSINESS:USER_SIGNUP_CODES:VIEW"],
  ].map(([file, permission]) => ({ file, url: `/${file}`, permission })),
